...
# https://github.com/dekopon-agents/dekopon, from the archives release v0.22.0 published.
...
class Dekopon < Formula
  ...
  # No explicit `version`: Homebrew scans 0.22.0 out of the download URL, and
  # `brew audit --strict` rejects restating it.

  on_macos do
    on_arm do
      url "https://github.com/dekopon-agents/dekopon/releases/download/v0.22.0/dekopon-0.22.0-aarch64-apple-darwin.tar.gz"
      sha256 "5b5316162334edc41fb230b26bdf846d5403418b605ca669dff08dd7013354fe"
    end
  end

  on_linux do
    on_arm do
      url "https://github.com/dekopon-agents/dekopon/releases/download/v0.22.0/dekopon-0.22.0-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "c4d4fa9efcd3d78c7c6c09cf76fdefad3eecf3799966f8d5d9a6d46db9257de1"
    end

    on_intel do
      url "https://github.com/dekopon-agents/dekopon/releases/download/v0.22.0/dekopon-0.22.0-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "547901f8c07c8f1cf930e6117bd3db5851646bd5816b545c6b5a2e9ffa2c322c"
    end
  end
  ...
  def caveats
    <<~EOS
      ...
      https://github.com/dekopon-agents/dekopon/tree/v0.22.0/examples/conditional-write/README.md
    EOS
  end
