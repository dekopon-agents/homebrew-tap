...
# https://github.com/dekopon-agents/dekopon, from the archives release v0.15.2 published.
...
class Dekopon < Formula
  ...
  # No explicit `version`: Homebrew scans 0.15.2 out of the download URL, and
  # `brew audit --strict` rejects restating it.

  on_macos do
    on_arm do
      url "https://github.com/dekopon-agents/dekopon/releases/download/v0.15.2/dekopon-0.15.2-aarch64-apple-darwin.tar.gz"
      sha256 "3317683ff678e3a1632269b5c287aef6af4b6465de4e3bbaa5f21de7ca9df561"
    end
  end

  on_linux do
    on_arm do
      url "https://github.com/dekopon-agents/dekopon/releases/download/v0.15.2/dekopon-0.15.2-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "3f2190e66d9a0a17971e786b3896965a35fab64851566e6b97d98e8b0b47c41a"
    end

    on_intel do
      url "https://github.com/dekopon-agents/dekopon/releases/download/v0.15.2/dekopon-0.15.2-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "f5ef25011eb7e40bcaf36cdae3ff0604580b90a2f067ecec0702c1276bacc994"
    end
  end
  ...
  def caveats
    <<~EOS
      ...
      https://github.com/dekopon-agents/dekopon/tree/v0.15.2/examples/conditional-write/README.md
    EOS
  end
