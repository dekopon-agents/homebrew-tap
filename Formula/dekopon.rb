...
# https://github.com/dekopon-agents/dekopon, from the archives release v0.17.0 published.
...
class Dekopon < Formula
  ...
  # No explicit `version`: Homebrew scans 0.17.0 out of the download URL, and
  # `brew audit --strict` rejects restating it.

  on_macos do
    on_arm do
      url "https://github.com/dekopon-agents/dekopon/releases/download/v0.17.0/dekopon-0.17.0-aarch64-apple-darwin.tar.gz"
      sha256 "2ee6ec088e1d77ff66fedc3d09df44732d06ddc75e55d612862875abced07ff9"
    end
  end

  on_linux do
    on_arm do
      url "https://github.com/dekopon-agents/dekopon/releases/download/v0.17.0/dekopon-0.17.0-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "b0346e96973876ab0820d7597e30251f32b49a216e64c482acf200950e44e886"
    end

    on_intel do
      url "https://github.com/dekopon-agents/dekopon/releases/download/v0.17.0/dekopon-0.17.0-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "1f35c1027a46af7dfe6303bc0d7169a4d223ea9e58e2599c79ce1f37033283da"
    end
  end
  ...
  def caveats
    <<~EOS
      ...
      https://github.com/dekopon-agents/dekopon/tree/v0.17.0/examples/conditional-write/README.md
    EOS
  end
